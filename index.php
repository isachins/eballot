            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                        ...
                        <div class="bg-gray-100">
                            <div
                                    ...
                                    <h2
                                        ...
                                        <span class="relative inline-block">
                                            <svg viewBox="0 0 52 24" fill="currentColor"
                                                ...
                                                <defs>
                                                    <pattern id="dc223fcc-6d72-4ebc-b4ef-abe121034d6e" x="0" y="0"
                                                        width=".135" height=".30">
                                ...
                                <div class="flex items-center sm:justify-center">
                                    ...
                                    <a href="/" aria-label=""
                                        class="inline-flex items-center font-semibold text-gray-800 transition-colors duration-200 hover:text-purple-700">Learn
                                        more...</a>
                                </div>
                            </div>
                        </div>
                        <div class="relative px-4 sm:px-0">
                            ...
                            <div
                                ...
                                <div class="inline-block p-8 text-center">
                                    <div
                                        class="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-full bg-indigo-50">
                    ...
                    <section class="bg-white dark:bg-gray-900">
                        <div class="container px-6 py-10 mx-auto">
                            ...
                            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
                                <div class="space-y-3">
                                    <span
                                        class="inline-block p-3 text-purple-500 bg-purple-100 rounded-full dark:text-white dark:bg-purple-500">
                                    ...
                                    <a href="#"
                                        class="inline-flex items-center -mx-1 text-sm text-purple-500 capitalize transition-colors duration-200 transform dark:text-purple-400 hover:underline hover:text-purple-600 dark:hover:text-purple-500">
                    ...
                    <form action="https://formspree.io/f/xrgjongl" method="POST">
                        ...
                        <div
                            class="max-w-screen-xl mt-12 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
                            ...
                            <div class="">
                                ...
                                <div class="mt-8">
                                    ...
                                    <textarea input type="text" name="message" placeholder="Enter your message here"
                                        required
                                ...
                                <div class="mt-8">
                                    <button type="submit"
                                        class="uppercase text-sm font-bold tracking-wide bg-purple-500 text-white p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                                        Send Message
                                    </button>
                                </div>
                            </div>
                    ...
                    <footer
                        ...
                        <a href="#"
                            class="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">eBallot</a>
