            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                   ...
                   <section class="bg-white dark:bg-gray-900">
                        ...
                        <h1 class="text-3xl mt-10 font-semibold text-center text-gray-800 capitalize lg:text-4xl dark:text-white">
                            Position Name
                        </h1>
                        <div class="container px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96">
                            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
                                <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                                    ...
                                    <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">Party</p>
                                </div>
                            </div>
